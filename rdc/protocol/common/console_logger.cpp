...
<<<<<<< HEAD
    ...
    int wide_length = MultiByteToWideChar(CP_UTF8,
                                          ...
                                          0);
    if (wide_length > 0) {
        std::vector<wchar_t> wide_buffer(static_cast<std::size_t>(wide_length) + 2, L'\0');
        const int converted_length = MultiByteToWideChar(CP_UTF8,
                                                         0,
                                                         line.data(),
                                                         static_cast<int>(line.size()),
                                                         wide_buffer.data(),
        ...
        if (converted_length > 0) {
            wide_buffer[static_cast<std::size_t>(converted_length)] = L'\n';
